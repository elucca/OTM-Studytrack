...
public class TaskEntry {
     ...
     * week. The information on which course the entry is related to is
     * contained in the TaskType object. TaskTypes are considered equal for each
     * TaskType for a given course week, such that in the data storage
     * mechanisms only one entry ever exists for a given combination of TaskType
     * and course week.
     *
     * @param date the date of the entry
     * @param courseWeek the week of the course the entry relates to, with the
     * minimum value being 1 (first week of a course), and the maximum being
     * arbitrary
    ...
    /**
     * Returns the hash code value for this TaskEntry. The hash code of two
     * TaskEntry objects will be equal if their taskType and courseWeek fields
     * are equal.
     *
    ...
    /**
     * Compares the provided object with this TaskEntry for equality. Two
     * TaskEntry objects are considered equal when their taskType and courseWeek
     * fields are equal.
     *
    ...
    public String toString() {
        return "TaskEntry{" + "timeSpent=" + timeSpent + ", taskType=" + taskType + '}';
    }
